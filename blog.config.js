...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZiyPee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.ziypee.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ZiyPee, 博客', // 网站关键词 英文逗号隔开
  ...
  ICP_BEI_AN: process.env.NEXT_PUBLIC_ICP_BEI_AN || '鄂ICP备2023010664号', // 备案号 闽ICP备XXXXXXX
  POLICE_BEI_AN: process.env.NEXT_PUBLIC_POLICE_BEI_AN || '鄂公网安备 42018502006751号', // 公网安备 鄂公网安备XXXXXXX
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-7E46QZLPLN', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
