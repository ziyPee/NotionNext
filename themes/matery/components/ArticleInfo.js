            ...
            <div className='flex flex-wrap gap-3 mt-5 text-sm'>
                {post?.type !== 'Page' && (<>
                    <Link
                        ...
                        <i className='far fa-calendar-minus fa-fw'/> {locale.COMMON.POST_TIME}: {post?.publishDate}

                    </Link>
                    <span className='whitespace-nowrap'>
                        <i className='far fa-calendar-check fa-fw' />{locale.COMMON.LAST_EDITED_TIME}: {post.lastEditedDate}
                    </span>
